...
createServer(function(request,response){
    ...
    const millisecondBetweenDOBAnd1970=Date.parse(DOB);
    const millisecondBetweenNowAnd1970=Date.now();
    const ageInMilliSeconds=millisecondBetweenNowAnd1970-millisecondBetweenDOBAnd1970;
